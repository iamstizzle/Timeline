...
filmandculture_deck =[
    ...
    [1991, "Disney's Beauty and the Beast (movie)"],
    [1991, "Terminator 2: Judgment Day (movie)"],
    [1991, "Point Break (movie)"],
    [1992, "Disney's Aladdin (movie)"],
    [1992, "A Few Good Men (movie)"],
    [1992, "Reservoir Dogs (movie)"],
    [1993, "Jurrassic Park (movie)"],
    [1986, "Labrynth (movie)"],
    ...
    [1970, "Disney's The Aristocats (movie)"],
    [1979, "Alien (movie)"],
